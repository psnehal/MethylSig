...
_magic_number = 6
_modified_time = 1415223215.5243709
...
def render_tool_menu_javascripts(context):
    ...
    try:
        ...
        if trans.user or not trans.app.config.require_login:
            ...
            # SOURCE LINE 28
            __M_writer(unicode( h.dumps( trans.app.toolbox.to_dict( trans, in_panel=False ) ) ))
            __M_writer(u' \n                                                        ),\n                        tool_panel = new tools_mod.ToolPanel({ \n                            tool_search: tool_search,\n                            tools: tools,\n                            layout: ')
            # SOURCE LINE 33
            __M_writer(unicode(h.dumps( trans.app.toolbox.to_dict( trans ) )))
