...
_magic_number = 6
_modified_time = 1433361517.566613
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 2
    ns = runtime.TemplateNamespace('__anon_0x87e5d10', context._clean_inheritance_tokens(), templateuri=u'/message.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x87e5d10')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x87e5d10')._populate(_import_ns, [u'render_msg'])
...
def render_left_panel(context):
    ...
    try:
        ...
        __M_writer(u'" target="galaxy_main">Manage users API keys</a></div>\n')
        # SOURCE LINE 56
        ...
        __M_writer(u'" target="galaxy_main">Download tool tarball</a></div>\n                        <div class="toolTitle"><a href="')
        # SOURCE LINE 80
