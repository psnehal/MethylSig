...
_magic_number = 6
_modified_time = 1433535698.892575
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 3
    ns = runtime.TemplateNamespace('__anon_0x7f902c5e93d0', context._clean_inheritance_tokens(), templateuri=u'/message.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f902c5e93d0')] = ns

    # SOURCE LINE 2
    ns = runtime.TemplateNamespace('__anon_0x7f902c5e9150', context._clean_inheritance_tokens(), templateuri=u'/user/info.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f902c5e9150')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7f902c5e93d0')._populate(_import_ns, [u'render_msg'])
        _mako_get_namespace(context, '__anon_0x7f902c5e9150')._populate(_import_ns, [u'render_user_info'])
        ...
        user_type_fd_id = _import_ns.get('user_type_fd_id', context.get('user_type_fd_id', UNDEFINED))
        ...
        if user.values or user_info_forms:
            ...
            if user_type_fd_id_select_field and len( user_type_fd_id_select_field.options ) >= 1:
                ...
                __M_writer(unicode(trans.security.encode_id( user_type_fd_id )))
                __M_writer(u'"/>\n')
                pass
            # SOURCE LINE 24
        ...
        if user.addresses:
            ...
            for index, address in enumerate(addresses):
                ...
                # SOURCE LINE 69
                __M_writer(filters.html_escape(unicode(address.desc )))
                __M_writer(u':</label>\n                                        ')
                # SOURCE LINE 70
