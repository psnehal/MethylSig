...
_magic_number = 6
_modified_time = 1415223370.8297219
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 2
    ns = runtime.TemplateNamespace('__anon_0x7f3d1001d510', context._clean_inheritance_tokens(), templateuri=u'/message.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f3d1001d510')] = ns

    # SOURCE LINE 3
    ns = runtime.TemplateNamespace('__anon_0x7f3d1802f510', context._clean_inheritance_tokens(), templateuri=u'/base_panels.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f3d1802f510')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7f3d1001d510')._populate(_import_ns, [u'render_msg'])
        _mako_get_namespace(context, '__anon_0x7f3d1802f510')._populate(_import_ns, [u'overlay'])
