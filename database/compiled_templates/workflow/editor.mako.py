...
_magic_number = 6
_modified_time = 1433451655.5417781
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 403
    ns = runtime.TemplateNamespace('__anon_0x7f902c265c50', context._clean_inheritance_tokens(), templateuri=u'/tagging_common.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f902c265c50')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7f902c265c50')._populate(_import_ns, [u'render_individual_tagging_element'])
