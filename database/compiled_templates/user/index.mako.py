...
_magic_number = 6
_modified_time = 1433535693.357856
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 2
    ns = runtime.TemplateNamespace('__anon_0x7f902c5d8110', context._clean_inheritance_tokens(), templateuri=u'/message.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f902c5d8110')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7f902c5d8110')._populate(_import_ns, [u'render_msg'])
        ...
        if trans.user:
            ...
            if t.webapp.name == 'galaxy':
                ...
                if not trans.app.config.use_remote_user:
                    ...
                    __M_writer(u'</a> (email, password, etc.)</li>\n')
                    pass
                # SOURCE LINE 16
                __M_writer(u'            <li><a href="')
            ...
            if t.webapp.name == 'galaxy':
                ...
                if trans.app.config.enable_quotas:
                    ...
                    pass
                # SOURCE LINE 36
                __M_writer(u'            Is your usage more than expected?  See the <a href="https://wiki.galaxyproject.org/Learn/ManagingDatasets" target="_blank">documentation</a> for tips on how to find all of the data in your account.\n        </p>\n')
                pass
            # SOURCE LINE 39
        else:
            # SOURCE LINE 40
