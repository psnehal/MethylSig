...
_magic_number = 6
_modified_time = 1433361616.318079
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 20
    ns = runtime.TemplateNamespace('__anon_0x7f9020123290', context._clean_inheritance_tokens(), templateuri=u'/display_common.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f9020123290')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7f9020123290')._populate(_import_ns, [u'get_class_plural'])
